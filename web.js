...
var mi_funcion= function(request, response){
  ...
  var codigo_html="<html><head></head><body>"
   ...
   codigo_html+="<li>Modelo: "+cpu_info[i]["model"]+"</li><li>Speed: "+cpu_info[i]["speed"]+"</li><li><p>Tiempos: </p><ul><li>user: "+cpu_info[i]["times"]["user"]+"</li><li>nice: "+cpu_info[i]["times"]["nice"]+"</li><li>sys: "+cpu_info[i]["times"]["sys"]+"</li><li>idle: "+cpu_info[i]["times"]["idle"]+"</li><li>irq: "+cpu_info[i]["times"]["irq"]+"</li></ul></li>"
   codigo_html+="<br>";
}
  codigo_html+="</li></ul>";	
