...
var mi_funcion= function(request, response){
  ...
  var codigo_html="<html><head></head><body>"
    codigo_html+="<ul><li><p>Sistema operativo: "+os_type+"</p></li><li><p>Plataforma: "+os.platform()+"</p> </li><li><p>Host name: "+os.hostname()+"</p></li><li><p>Arquitectura CPU OS: "+os.arch()+"</p></li><li><p>Directorio archivos temporales: "+os.tmpdir()+"</p></li><li><p>Host name: "+os.hostname()+"</p></li><li><p>Endianness de la CPU: "+os.endianness()+"</p></li></ul>";	
